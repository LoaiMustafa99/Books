...
<aside class="app-sidebar">
    ...
    <div class="app-sidebar__user">
        ...
        <div>
            <p class="app-sidebar__user-name">{{__("Ahmad Mohammad")}}</p>
            <p class="app-sidebar__user-name" style="font-size: 14px; color: #f2f2f2">{{__("Admin")}}</p>
        </div>
    </div>
    <ul class="app-menu">

            <li><a class="app-menu__item @if(request()->routeIs("dashboard.index")) active @endif" href="{{route("dashboard.index")}}"><i class="app-menu__icon fas fa-tachometer-alt"></i><span class="app-menu__label">{{{__("Dashboard")}}}</span></a></li>

            <!------------------------- Cities -------------------------->
            <li class="treeview @if(request()->routeIs("admin.city.*")) is-expanded @endif"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-city"></i><span class="app-menu__label">{{__("Services Cities")}}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            ...
            <!------------------------- Sections -------------------------->
            <li class="treeview @if(request()->routeIs("admin.sections.*")) is-expanded @endif"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fas fa-th-large"></i><span class="app-menu__label">{{__("Sections")}}}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item @if(request()->routeIs("admin.sections.create")) active @endif" href="{{ route("admin.sections.create") }}"><i class="icon fa fa-circle-o"></i>{{__("Create Section")}}</a></li>
                    <li><a class="treeview-item @if(request()->routeIs("admin.sections.index")) active @endif" href="{{ route("admin.sections.index") }}"><i class="icon fa fa-circle-o"></i>{{__("All Sections")}}</a></li>
                </ul>
            </li>
